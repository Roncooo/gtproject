...
if __name__ == "__main__":
    ...
    start = time.time()
    results = play_n_games_for_each_policy_combination(n_games = n_games, policies=policies, play_one_game_function = play_one_game_1, print_game_function = print_game_1, seed=None, log_game=False)
    end = time.time()
